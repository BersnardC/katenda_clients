...
const dict = {
  es: {
    ...
    "store.popupBlocked": "Tu navegador bloqueó la apertura automática. Toca el botón para enviar el pedido por WhatsApp.",
  ...
  en: {
    ...
    "store.popupBlocked": "Your browser blocked the automatic opening. Tap the button to send your order on WhatsApp.",
